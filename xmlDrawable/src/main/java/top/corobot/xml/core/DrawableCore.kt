...
class DrawableCore {
    ...
    fun setShape(shape: Shape): DrawableCore {
        this.shape = shape
        return this
    }

    fun setSolidColor(@ColorInt solidColor: Int): DrawableCore {
        this.solidColor = solidColor
        return this
    }

    fun setCornersRadius(@Px cornersRadius: Float): DrawableCore {
    ...
    fun setGradientAngle(gradientAngle: Int): DrawableCore {
        this.gradientAngle = gradientAngle
        return this
    }

    fun setGradientCenterXY(gradientCenterX: Float?, gradientCenterY: Float?): DrawableCore {
    ...
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    fun setGradientColor(@ColorInt startColor: Int?, @ColorInt endColor: Int?): DrawableCore {
    ...
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    fun setGradientColor(@ColorInt startColor: Int?, @ColorInt centerColor: Int?, @ColorInt endColor: Int?): DrawableCore {
        gradientStartColor = startColor
    ...
    fun setGradientRadius(@Px gradientRadius: Float): DrawableCore {
        this.gradientRadius = gradientRadius
        return this
    }

    fun setGradient(gradient: Gradient): DrawableCore {
        this.gradient = gradient
        return this
    }

    fun setUseLevel(useLevel: Boolean): DrawableCore {
        this.useLevel = useLevel
        return this
    }

    fun setPadding(@Px paddingLeft: Float, @Px paddingTop: Float, @Px paddingRight: Float, @Px paddingBottom: Float): DrawableCore {
    ...
    fun setSizeWidth(@Px sizeWidth: Float): DrawableCore {
        this.sizeWidth = sizeWidth
        return this
    }

    fun setSizeHeight(@Px sizeHeight: Float): DrawableCore {
        this.sizeHeight = sizeHeight
        return this
    }

    fun setStrokeWidth(@Px strokeWidth: Float): DrawableCore {
        this.strokeWidth = strokeWidth
        return this
    }

    fun setStrokeColor(@ColorInt strokeColor: Int): DrawableCore {
        this.strokeColor = strokeColor
        return this
    }

    fun setStrokeDashWidth(@Px strokeDashWidth: Float): DrawableCore {
        this.strokeDashWidth = strokeDashWidth
        return this
    }

    fun setStrokeDashGap(@Px strokeDashGap: Float): DrawableCore {
        this.strokeDashGap = strokeDashGap
        return this
    }

    fun setRipple(rippleEnable: Boolean, @ColorInt rippleColor: Int): DrawableCore {
        this.rippleEnable = rippleEnable
        this.rippleColor = rippleColor
        return this
    }

    fun setCheckableStrokeColor(@ColorInt checkableStrokeColor: Int, @ColorInt unCheckableStrokeColor: Int): DrawableCore {
        this.checkableStrokeColor = checkableStrokeColor
        this.unCheckableStrokeColor = unCheckableStrokeColor
        return this
    }

    fun setCheckedStrokeColor(@ColorInt checkedStrokeColor: Int, @ColorInt unCheckedStrokeColor: Int): DrawableCore {
        this.checkedStrokeColor = checkedStrokeColor
        this.unCheckedStrokeColor = unCheckedStrokeColor
        return this
    }

    fun setEnabledStrokeColor(@ColorInt enabledStrokeColor: Int, @ColorInt unEnabledStrokeColor: Int): DrawableCore {
        this.enabledStrokeColor = enabledStrokeColor
        this.unEnabledStrokeColor = unEnabledStrokeColor
        return this
    }

    fun setSelectedStrokeColor(@ColorInt selectedStrokeColor: Int, @ColorInt unSelectedStrokeColor: Int): DrawableCore {
        this.selectedStrokeColor = selectedStrokeColor
        this.unSelectedStrokeColor = unSelectedStrokeColor
        return this
    }

    fun setPressedStrokeColor(@ColorInt pressedStrokeColor: Int, @ColorInt unPressedStrokeColor: Int): DrawableCore {
        this.pressedStrokeColor = pressedStrokeColor
        this.unPressedStrokeColor = unPressedStrokeColor
        return this
    }

    fun setFocusedStrokeColor(@ColorInt focusedStrokeColor: Int, @ColorInt unFocusedStrokeColor: Int): DrawableCore {
        this.focusedStrokeColor = focusedStrokeColor
        this.unFocusedStrokeColor = unFocusedStrokeColor
        return this
    }

    fun setCheckableSolidColor(@ColorInt checkableSolidColor: Int, @ColorInt unCheckableSolidColor: Int): DrawableCore {
        this.checkableSolidColor = checkableSolidColor
        this.unCheckableSolidColor = unCheckableSolidColor
        return this
    }

    fun setCheckedSolidColor(@ColorInt checkedSolidColor: Int, @ColorInt unCheckedSolidColor: Int): DrawableCore {
        this.checkedSolidColor = checkedSolidColor
        this.unCheckedSolidColor = unCheckedSolidColor
        return this
    }

    fun setEnabledSolidColor(@ColorInt enabledSolidColor: Int, @ColorInt unEnabledSolidColor: Int): DrawableCore {
        this.enabledSolidColor = enabledSolidColor
        this.unEnabledSolidColor = unEnabledSolidColor
        return this
    }

    fun setSelectedSolidColor(@ColorInt selectedSolidColor: Int, @ColorInt unSelectedSolidColor: Int): DrawableCore {
        this.selectedSolidColor = selectedSolidColor
        this.unSelectedSolidColor = unSelectedSolidColor
        return this
    }

    fun setPressedSolidColor(@ColorInt pressedSolidColor: Int, @ColorInt unPressedSolidColor: Int): DrawableCore {
        this.pressedSolidColor = pressedSolidColor
        this.unPressedSolidColor = unPressedSolidColor
        return this
    }

    fun setFocusedSolidColor(@ColorInt focusedSolidColor: Int, @ColorInt unFocusedSolidColor: Int): DrawableCore {
        this.focusedSolidColor = focusedSolidColor
        this.unFocusedSolidColor = unFocusedSolidColor
        return this
    }

    fun setCheckableDrawable(checkableDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.checkableDrawable = checkableDrawable
        return this
    }

    fun setCheckedDrawable(checkedDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.checkedDrawable = checkedDrawable
        return this
    }

    fun setEnabledDrawable(enabledDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.enabledDrawable = enabledDrawable
        return this
    }

    fun setSelectedDrawable(selectedDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.selectedDrawable = selectedDrawable
        return this
    }

    fun setPressedDrawable(pressedDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.pressedDrawable = pressedDrawable
        return this
    }

    fun setFocusedDrawable(focusedDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.focusedDrawable = focusedDrawable
        return this
    }

    fun setFocusedHovered(focusedHovered: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.focusedHovered = focusedHovered
        return this
    }

    fun setFocusedActivated(focusedActivated: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.focusedActivated = focusedActivated
        return this
    }

    fun setUnCheckableDrawable(unCheckableDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.unCheckableDrawable = unCheckableDrawable
        return this
    }

    fun setUnCheckedDrawable(unCheckedDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.unCheckedDrawable = unCheckedDrawable
        return this
    }

    fun setUnEnabledDrawable(unEnabledDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.unEnabledDrawable = unEnabledDrawable
        return this
    }

    fun setUnSelectedDrawable(unSelectedDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.unSelectedDrawable = unSelectedDrawable
        return this
    }

    fun setUnPressedDrawable(unPressedDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.unPressedDrawable = unPressedDrawable
        return this
    }

    fun setUnFocusedDrawable(unFocusedDrawable: Drawable?): DrawableCore {
        hasSelectDrawable = true
        hasSelectDrawable = true
    ...
    fun setUnFocusedHovered(unFocusedHovered: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.unFocusedHovered = unFocusedHovered
        return this
    }

    fun setUnFocusedActivated(unFocusedActivated: Drawable?): DrawableCore {
        hasSelectDrawable = true
        this.unFocusedActivated = unFocusedActivated
        return this
    }

    fun setCheckableTextColor(checkableTextColor: Int): DrawableCore {
        this.checkableTextColor = checkableTextColor
        textColorCount++
        return this
    }

    fun setCheckedTextColor(checkedTextColor: Int): DrawableCore {
        this.checkedTextColor = checkedTextColor
        textColorCount++
        return this
    }

    fun setEnabledTextColor(enabledTextColor: Int): DrawableCore {
        this.enabledTextColor = enabledTextColor
        textColorCount++
        return this
    }

    fun setSelectedTextColor(selectedTextColor: Int): DrawableCore {
        this.selectedTextColor = selectedTextColor
        textColorCount++
        return this
    }

    fun setPressedTextColor(pressedTextColor: Int): DrawableCore {
        this.pressedTextColor = pressedTextColor
        textColorCount++
        return this
    }

    fun setFocusedTextColor(focusedTextColor: Int): DrawableCore {
        this.focusedTextColor = focusedTextColor
        textColorCount++
        return this
    }

    fun setUnCheckableTextColor(unCheckableTextColor: Int): DrawableCore {
        this.unCheckableTextColor = unCheckableTextColor
        textColorCount++
        return this
    }

    fun setUnCheckedTextColor(unCheckedTextColor: Int): DrawableCore {
        this.unCheckedTextColor = unCheckedTextColor
        textColorCount++
        return this
    }

    fun setUnEnabledTextColor(unEnabledTextColor: Int): DrawableCore {
        this.unEnabledTextColor = unEnabledTextColor
        textColorCount++
        return this
    }

    fun setUnSelectedTextColor(unSelectedTextColor: Int): DrawableCore {
        this.unSelectedTextColor = unSelectedTextColor
        textColorCount++
        return this
    }

    fun setUnPressedTextColor(unPressedTextColor: Int): DrawableCore {
        this.unPressedTextColor = unPressedTextColor
        textColorCount++
        return this
    }

    fun setUnFocusedTextColor(unFocusedTextColor: Int): DrawableCore {
        this.unFocusedTextColor = unFocusedTextColor
        textColorCount++
        return this
    }

    fun setBaseGradientDrawable(baseGradientDrawable: GradientDrawable?): DrawableCore {
        this.baseGradientDrawable = baseGradientDrawable
        return this
    }

    fun setBaseStateListDrawable(baseStateListDrawable: StateListDrawable?): DrawableCore {
